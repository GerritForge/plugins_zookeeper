...
public class ZkValidationModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    DynamicSet.setOf(binder(), StringToGenericDeserializer.class);
    DynamicSet.bind(binder(), StringToGenericDeserializer.class).to(StringToIntDeserializer.class);
    DynamicSet.bind(binder(), StringToGenericDeserializer.class).to(StringToLongDeserializer.class);
    DynamicSet.bind(binder(), StringToGenericDeserializer.class)
